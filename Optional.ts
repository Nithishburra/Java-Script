...
/*
function fun_one(op1:any,op2:string,op3?:string,op4="hi"):void{
      console.log(op1,op2,op3,op4);
}
 fun_one("hello","hi");//hello hi undefined hi
 fun_one("hi","bye","welcome");//hi bye welcome hi   
 fun_one(undefined ,null,null,undefined);//undefined null null hi
 */